...
elseif &t_Co == 256
	...
	hi VertSplit      ctermbg=234  ctermfg=235   cterm=none
	...
	" Folding
	hi FoldColumn     ctermbg=234  ctermfg=4    cterm=none
	hi Folded         ctermbg=234  ctermfg=4    cterm=none

	" Line
	hi LineNr         ctermbg=233  ctermfg=239   cterm=none
	hi StatusLine     ctermbg=235  ctermfg=45   cterm=none
	hi StatusLineNC   ctermbg=235  ctermfg=252   cterm=none

	" Messages
	hi ErrorMsg       ctermbg=234  ctermfg=252   cterm=none
	hi Question       ctermbg=234  ctermfg=214   cterm=none
	hi WarningMsg     ctermbg=234  ctermfg=214     cterm=none
	...
	" Menu
	hi Pmenu          ctermbg=234  ctermfg=231   cterm=none
	...
	"
	" Visual
	hi Visual         ctermbg=236  ctermfg=11   cterm=none 
